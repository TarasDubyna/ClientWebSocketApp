...
public class NetworkScanner {
    ...
    public NetworkScanner(Context applicationContext, Runnable runnable) {
    }

    public interface NetworkScannerResponse{
    ...
    Socket socket = null;
    NetworkScannerResponse networkScannerResponse;

    public NetworkScanner(Context mContext, NetworkScannerResponse networkScannerResponse) {
        this.networkScannerResponse = networkScannerResponse;
    ...
    private boolean checkWiFiConnection(){
        ...
        networkScannerResponse.errorResponse("No Wifi");
            ...
            try {
                while(true) {
                    ...
                    while(state){
                        ...
                        networkScannerResponse.successResponse(stringBuilder.toString());
